...
goog.scope=function(a){a.call(goog.global)};(function(){var a,b,c,d,e,f;chrome.extension.onRequest.addListener(function(a){if("insertTextToActiveElement"===a.action)return c(document,a.text)});c=function(a,b){var h;h=a.activeElement;return"IFRAME"===h.tagName?c(h.contentDocument,b):void 0!==h.value?e(h,b):d(a,b)};e=function(a,c){var d,e;e=a.selectionStart;d=a.selectionEnd;2===c.length?(d++,b(a,e,c[0]),b(a,d,c[1])):b(a,d,c);return f(a,d+1)};d=function(b,c){var d,e,f,j,i;d=b.getSelection();i=d.anchorNode;j=d.anchorOffset;f=d.focusNode;e=d.focusOffset;
2===c.length?(i===f&&e++,i.textContent=a(i.textContent,j,c[0]),f.textContent=a(f.textContent,e,c[1])):f.textContent=a(f.textContent,e,c);return d.setPosition(f,e+1)};b=function(b,c,d){return b.value=a(b.value,c,d)};a=function(a,b,c){return a.substr(0,b)+c+a.substr(b,a.length)};return f=function(a,b){return a.setSelectionRange(b,b)}})();
